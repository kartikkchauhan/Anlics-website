<div class="col-lg-8" style="margin-top: 70px;" id="main">
	...
	<h1 style="font-size: 22px;">GOVERMENT JOBS</h1>
	<div class="row" style="margin-top: 10px;border:1px solid #DDDDDD; height: auto;">
		...
		if($article->categoryName == "CAREER" && $article->subCategoryName == "GOVERMENT JOBS")	
		{
		?>
			<div class="col-lg-12" style="margin-top: 10px; margin-bottom: 10px;">
				...
				<div class="col-lg-8">
				<p style=""><?= anchor(base_url('home/fullDetails/'.$article->postId),$article->title) ?></p>
				</div>
			</div>
			<div class="col-lg-12 ">
